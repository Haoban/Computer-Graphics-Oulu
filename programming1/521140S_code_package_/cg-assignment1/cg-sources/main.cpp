...
void dump_obj_info(const ObjParser &obj)
{
	...
	std::map<std::string, ObjParser::Material>::const_iterator mat_it;
	...
	std::map<std::string, ObjParser::VertexSet>::const_iterator obj_it;
...
//  OutputDebugPrintf("Output Check\n");
	...
	std::string window_name = "CG 2019 example";              // Created window name - should be UTF-8 string for libSDL
